...
|---|---|---|---|---|---|
| Day 0 | Baseline bootstrap complete | P0 | Bootstrap scripts + deploy baseline + подтвержденный production bootstrap | `docs/delivery/epics/epic-s1-day0-bootstrap-baseline.md` | completed |
| Day 1 | Webhook ingress + idempotency | P0 | Webhook endpoint + signature verify + dedup + production smoke evidence | `docs/delivery/epics/epic-s1-day1-webhook-idempotency.md` | completed |
...
| Day 6 | Security/Network/Observability hardening for production | P1 | DNS/TLS/firewall checks + observability baseline | `docs/delivery/epics/epic-s1-day6-hardening-observability.md` | completed |
