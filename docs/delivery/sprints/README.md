...
related_issues: [112, 154, 184, 185, 187, 189, 195, 197, 199, 201, 212, 218, 220, 222, 216]
related_prs: []
approvals:
  required: ["Owner"]
  status: pending
...
| S7 | `docs/delivery/sprints/s7/sprint_s7_mvp_readiness_gap_closure.md` | `docs/delivery/epics/s7/epic_s7.md` | in-progress | Day1 intake (`#212`) и Day2 vision (`#218`) сформировали baseline, Day3 PRD (`#220`) зафиксировал FR/AC/NFR + sequencing по `S7-E01..S7-E18`, создана follow-up issue `#222` для `run:arch` без trigger-лейбла. |
