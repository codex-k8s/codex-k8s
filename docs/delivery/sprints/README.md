...
| S6 | `docs/delivery/sprints/s6/sprint_s6_agents_prompt_management.md` | `docs/delivery/epics/s6/epic_s6.md` | in-progress | Intake+Vision закрыты (`#184`, `#185`), PRD stage вынесен в issue `#187`. |
