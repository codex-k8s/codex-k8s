...
- существующий PR body из исходной implementation-итерации сохраняется; revise-цикл не должен перетирать уже опубликованный контекст, трассируемость и историю проверок;
- перед обновлением PR body нужно сначала получить текущее описание существующего PR и встраивать revise-заметки поверх него;
