...
| `docs/delivery/epics/s8/` | Day1 plan + Day2/Day3 onboarding эпики + каталог Sprint S8 (Go refactoring + repository onboarding automation) + execution backlog `S8-E01..S8-E08` | `docs/delivery/epics/s8/epic_s8.md` |
