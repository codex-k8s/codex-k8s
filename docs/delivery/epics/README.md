...
related_issues: [112, 154, 184, 185, 187, 189, 195, 197, 199, 201, 212, 218, 220, 222, 238, 241, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 216, 262, 263, 265, 281, 282, 320, 327, 333, 335, 337, 340, 351, 360, 361, 363, 366, 369, 370, 371, 372, 373, 374, 375, 378, 383, 385, 387, 389, 391, 392, 393, 394, 395, 413, 416, 418, 444, 447, 448, 452, 454, 469, 471, 476, 480, 484, 490, 492, 494, 496, 510, 537, 541, 542, 543, 544, 545, 546, 547, 554, 557, 559, 561, 562, 563, 565, 567, 568, 571, 573, 575, 579, 582]
related_prs: []
approvals:
  required: ["Owner"]
  status: pending
...
| `docs/delivery/epics/s17/` | Day1 intake + Day2 vision + Day3 PRD package (`epic + prd`) + Day4 architecture package (`epic + initiative + ADR/alternatives`) + Day5 design package (`epic + design_doc/api_contract/data_model/migrations_policy`) + Day6 plan package (`epic-s17-day6-unified-user-interaction-waits-and-owner-feedback-inbox-plan.md`) для unified owner feedback loop; issue `#559` закрепила ownership/live-wait baseline, issue `#568` выпустила implementation-ready contracts, а issue `#575` зафиксировала execution package и создала handover issue `#582` для `run:dev` | `docs/delivery/epics/s17/epic_s17.md` |
| `docs/delivery/epics/s18/` | Day1 intake + Day2 vision для frontend-first Mission Control reset на fake data: issue `#562` зафиксировала fullscreen canvas, taxonomy `Issue/PR/Run`, compact nodes, workflow editor UX, platform-safe actions only и isolated `web-console` prototype как цель `run:dev`; issue `#565` закрепила mission/KPI/guardrails и создала issue `#567` для `run:prd`, а backend rebuild остаётся отдельной задачей `#563` после owner approval UX. | `docs/delivery/epics/s18/epic_s18.md` |
