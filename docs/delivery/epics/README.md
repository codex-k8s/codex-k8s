...
| `docs/delivery/epics/s7/` | Day1 intake + созданная Day2 vision issue `#218` + каталог Sprint S7 (MVP readiness gap closure) + candidate backlog `S7-E01..S7-E18` | `docs/delivery/epics/s7/epic_s7.md` |
