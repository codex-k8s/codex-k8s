...
related_issues: [112, 154, 184, 185, 187, 189, 195, 197, 199, 201, 212, 218, 220, 222, 238, 241, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259, 260, 216, 262, 263, 265, 281, 282, 320, 327, 333, 335]
related_prs: []
approvals:
  required: ["Owner"]
  status: pending
...
## TL;DR
- Все day-эпики сгруппированы по папкам спринтов (`s1`, `s2`, `s3`, `s4`, `s5`, `s6`, `s7`, `s8`, `s9`).
...
| `docs/delivery/epics/s9/` | Day1 intake-пакет для Mission Control Dashboard + каталог Sprint S9 (control-plane UX, active-set dashboard, discussion-first flow, realtime/provider reconciliation) | `docs/delivery/epics/s9/epic_s9.md` |
