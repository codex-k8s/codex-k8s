...
| `docs/delivery/epics/s11/` | Day1 intake + Day2 vision для Telegram-адаптера как первого внешнего channel path + каталог Sprint S11; active vision stage идёт в issue `#447`, continuity issue `#444` 2026-03-14 закрыта как `state:superseded` historical handover, а issue `#448` создана для `run:prd` | `docs/delivery/epics/s11/epic_s11.md` |
