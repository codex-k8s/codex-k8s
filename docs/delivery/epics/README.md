...
| `docs/delivery/epics/s10/` | Day1 intake + Day2 vision package (`#378`) + continuity issue `#383` для PRD и каталог Sprint S10 вокруг built-in MCP user interactions, channel-neutral interaction-domain и follow-up adapter streams | `docs/delivery/epics/s10/epic_s10.md` |
