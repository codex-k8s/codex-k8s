...
- Полный runtime e2e для Day6 control tools (`mcp_secret_sync_env`, `mcp_database_lifecycle`, `mcp_owner_feedback_request`) в production-режиме approval/deny закреплён в Sprint S3 Day3..Day5.
