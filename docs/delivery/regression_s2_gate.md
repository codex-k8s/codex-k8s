...
- Полный runtime e2e для Day6 control tools (`secret.sync.github_k8s`, `database.lifecycle`, `mcp_owner_feedback_request`) в production-режиме approval/deny закреплён в Sprint S3 Day3..Day5.
