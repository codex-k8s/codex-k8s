...
related_issues: [325, 327, 333, 335, 337, 340, 351, 360, 361, 363, 366, 369, 370, 371, 372, 373, 374, 375, 378, 383, 385, 387, 413, 416, 418, 444, 447, 448, 452, 454, 456, 469, 471, 476, 480, 484, 490, 492, 494, 496, 510]
related_prs: []
approvals:
  required: ["Owner"]
  status: pending
...
| `docs/delivery/traceability/s16_mission_control_graph_workspace_history.md` | Sprint S16 | История intake и vision baseline по полному redesign Mission Control: absorption of issue `#480`, owner request `#490`, hybrid truth matrix, multi-root graph baseline, continuity rule, vision package `#496` и follow-up issue `#510` для `run:prd` |
