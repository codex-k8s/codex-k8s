# Рекомендации по доработке `docs/design-guidelines/go/mq.md`

- Дорабатываемый документ: [docs/design-guidelines/go/mq.md#L1-L15](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/mq.md#L1-L15)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/mq.md#L1-L15](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/mq.md#L1-L15) (ориентир: `Документ целиком`).
