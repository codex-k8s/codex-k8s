# Рекомендации по доработке `docs/design-guidelines/go/rest.md`

- Дорабатываемый документ: [docs/design-guidelines/go/rest.md#L1-L44](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/rest.md#L1-L44)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/rest.md#L1-L44](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/rest.md#L1-L44) (ориентир: `REST/HTTP в Go`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/rest.md#L1-L44](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/rest.md#L1-L44) (ориентир: `Документ целиком`).
