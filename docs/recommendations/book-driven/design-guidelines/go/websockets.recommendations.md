# Рекомендации по доработке `docs/design-guidelines/go/websockets.md`

- Дорабатываемый документ: [docs/design-guidelines/go/websockets.md#L1-L35](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/websockets.md#L1-L35)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/websockets.md#L1-L35](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/websockets.md#L1-L35) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/websockets.md#L5-L9](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/websockets.md#L5-L9) (ориентир: `Контракт (AsyncAPI)`).
