# Рекомендации по доработке `docs/design-guidelines/go/error_handling.md`

- Дорабатываемый документ: [docs/design-guidelines/go/error_handling.md#L1-L97](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/error_handling.md#L1-L97)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/error_handling.md#L1-L97](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/error_handling.md#L1-L97) (ориентир: `Обработка ошибок (обязательные правила)`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/error_handling.md#L36-L45](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/error_handling.md#L36-L45) (ориентир: `HTTP + OpenAPI`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/error_handling.md#L1-L97](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/error_handling.md#L1-L97) (ориентир: `Документ целиком`).
