# Рекомендации по доработке `docs/design-guidelines/go/code_commenting_rules.md`

- Дорабатываемый документ: [docs/design-guidelines/go/code_commenting_rules.md#L1-L78](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/code_commenting_rules.md#L1-L78)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/code_commenting_rules.md#L1-L78](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/code_commenting_rules.md#L1-L78) (ориентир: `Правила комментирования кода в Go`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/code_commenting_rules.md#L1-L78](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/code_commenting_rules.md#L1-L78) (ориентир: `Документ целиком`).
