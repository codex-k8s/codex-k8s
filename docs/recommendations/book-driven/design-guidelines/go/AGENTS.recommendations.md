# Рекомендации по доработке `docs/design-guidelines/go/AGENTS.md`

- Дорабатываемый документ: [docs/design-guidelines/go/AGENTS.md#L1-L22](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/AGENTS.md#L1-L22)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/AGENTS.md#L1-L22](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/AGENTS.md#L1-L22) (ориентир: `Документ целиком`).
