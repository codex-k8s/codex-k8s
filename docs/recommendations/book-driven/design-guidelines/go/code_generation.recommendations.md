# Рекомендации по доработке `docs/design-guidelines/go/code_generation.md`

- Дорабатываемый документ: [docs/design-guidelines/go/code_generation.md#L1-L66](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/code_generation.md#L1-L66)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/code_generation.md#L5-L13](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/code_generation.md#L5-L13) (ориентир: `Общие правила`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/code_generation.md#L1-L66](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/code_generation.md#L1-L66) (ориентир: `Кодогенерация (контракты -> код)`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/code_generation.md#L1-L66](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/code_generation.md#L1-L66) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/code_generation.md#L41-L54](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/code_generation.md#L41-L54) (ориентир: `AsyncAPI (webhook/event payloads)`).
