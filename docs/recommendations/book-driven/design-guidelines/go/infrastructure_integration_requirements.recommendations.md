# Рекомендации по доработке `docs/design-guidelines/go/infrastructure_integration_requirements.md`

- Дорабатываемый документ: [docs/design-guidelines/go/infrastructure_integration_requirements.md#L1-L56](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/infrastructure_integration_requirements.md#L1-L56)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/infrastructure_integration_requirements.md#L6-L16](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/infrastructure_integration_requirements.md#L6-L16) (ориентир: `PostgreSQL: обязательная модель хранения`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/infrastructure_integration_requirements.md#L1-L56](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/infrastructure_integration_requirements.md#L1-L56) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/infrastructure_integration_requirements.md#L31-L37](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/infrastructure_integration_requirements.md#L31-L37) (ориентир: `Webhook/event processing`).
