# Рекомендации по доработке `docs/design-guidelines/go/grpc.md`

- Дорабатываемый документ: [docs/design-guidelines/go/grpc.md#L1-L19](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/grpc.md#L1-L19)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/grpc.md#L1-L19](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/grpc.md#L1-L19) (ориентир: `gRPC в Go`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/grpc.md#L1-L19](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/grpc.md#L1-L19) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/grpc.md#L5-L8](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/grpc.md#L5-L8) (ориентир: `Контракт`).
