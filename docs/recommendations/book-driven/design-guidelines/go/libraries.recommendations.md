# Рекомендации по доработке `docs/design-guidelines/go/libraries.md`

- Дорабатываемый документ: [docs/design-guidelines/go/libraries.md#L1-L30](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/libraries.md#L1-L30)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/libraries.md#L21-L26](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/libraries.md#L21-L26) (ориентир: `Что запрещено выносить`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/libraries.md#L27-L30](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/libraries.md#L27-L30) (ориентир: `Контракты транспорта`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/libraries.md#L1-L30](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/libraries.md#L1-L30) (ориентир: `Документ целиком`).
