# Рекомендации по доработке `docs/design-guidelines/go/services_design_requirements.md`

- Дорабатываемый документ: [docs/design-guidelines/go/services_design_requirements.md#L1-L82](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/services_design_requirements.md#L1-L82)
...
Фрагмент документа для изменения: [docs/design-guidelines/go/services_design_requirements.md#L24-L27](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/services_design_requirements.md#L24-L27) (ориентир: `gRPC (внутренний sync)`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/services_design_requirements.md#L77-L82](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/services_design_requirements.md#L77-L82) (ориентир: `Запрещено`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/services_design_requirements.md#L36-L54](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/services_design_requirements.md#L36-L54) (ориентир: `Внутренняя структура Go-сервиса`).
...
Фрагмент документа для изменения: [docs/design-guidelines/go/services_design_requirements.md#L1-L82](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/go/services_design_requirements.md#L1-L82) (ориентир: `Документ целиком`).
