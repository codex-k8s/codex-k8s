# Рекомендации по доработке `docs/design-guidelines/AGENTS.md`

- Дорабатываемый документ: [docs/design-guidelines/AGENTS.md#L1-L21](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/AGENTS.md#L1-L21)
...
Фрагмент документа для изменения: [docs/design-guidelines/AGENTS.md#L1-L21](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/AGENTS.md#L1-L21) (ориентир: `Документ целиком`).
