# Рекомендации по доработке `docs/design-guidelines/vue/AGENTS.md`

- Дорабатываемый документ: [docs/design-guidelines/vue/AGENTS.md#L1-L16](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/AGENTS.md#L1-L16)
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/AGENTS.md#L1-L16](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/AGENTS.md#L1-L16) (ориентир: `Документ целиком`).
