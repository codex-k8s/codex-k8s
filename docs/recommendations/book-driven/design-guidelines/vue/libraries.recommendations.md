# Рекомендации по доработке `docs/design-guidelines/vue/libraries.md`

- Дорабатываемый документ: [docs/design-guidelines/vue/libraries.md#L1-L30](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/libraries.md#L1-L30)
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/libraries.md#L1-L30](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/libraries.md#L1-L30) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/libraries.md#L1-L30](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/libraries.md#L1-L30) (ориентир: `Vue/TS: что выносить в `libs/{vue|ts|js}``).
