# Рекомендации по доработке `docs/design-guidelines/vue/frontend_error_handling.md`

- Дорабатываемый документ: [docs/design-guidelines/vue/frontend_error_handling.md#L1-L38](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_error_handling.md#L1-L38)
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/frontend_error_handling.md#L1-L38](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_error_handling.md#L1-L38) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/frontend_error_handling.md#L24-L28](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_error_handling.md#L24-L28) (ориентир: `Что запрещено`).
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/frontend_error_handling.md#L29-L35](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_error_handling.md#L29-L35) (ориентир: `Стратегии UX`).
