# Рекомендации по доработке `docs/design-guidelines/vue/frontend_architecture.md`

- Дорабатываемый документ: [docs/design-guidelines/vue/frontend_architecture.md#L1-L49](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_architecture.md#L1-L49)
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/frontend_architecture.md#L3-L8](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_architecture.md#L3-L8) (ориентир: `Где живёт фронтенд`).
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/frontend_architecture.md#L45-L49](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_architecture.md#L45-L49) (ориентир: `Запрещено`).
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/frontend_architecture.md#L1-L49](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_architecture.md#L1-L49) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/frontend_architecture.md#L27-L44](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_architecture.md#L27-L44) (ориентир: `Рекомендуемая структура приложения`).
