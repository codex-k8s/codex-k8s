# Рекомендации по доработке `docs/design-guidelines/vue/frontend_data_and_state.md`

- Дорабатываемый документ: [docs/design-guidelines/vue/frontend_data_and_state.md#L1-L67](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_data_and_state.md#L1-L67)
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/frontend_data_and_state.md#L1-L67](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_data_and_state.md#L1-L67) (ориентир: `Frontend: данные, state и интеграции`).
...
Фрагмент документа для изменения: [docs/design-guidelines/vue/frontend_data_and_state.md#L1-L67](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/vue/frontend_data_and_state.md#L1-L67) (ориентир: `Документ целиком`).
