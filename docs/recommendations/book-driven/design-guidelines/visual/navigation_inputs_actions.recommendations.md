# Рекомендации по доработке `docs/design-guidelines/visual/navigation_inputs_actions.md`

- Дорабатываемый документ: [docs/design-guidelines/visual/navigation_inputs_actions.md#L1-L51](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/navigation_inputs_actions.md#L1-L51)
...
Фрагмент документа для изменения: [docs/design-guidelines/visual/navigation_inputs_actions.md#L1-L51](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/navigation_inputs_actions.md#L1-L51) (ориентир: `Навигация, ввод и действия`).
...
Фрагмент документа для изменения: [docs/design-guidelines/visual/navigation_inputs_actions.md#L1-L51](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/navigation_inputs_actions.md#L1-L51) (ориентир: `Документ целиком`).
