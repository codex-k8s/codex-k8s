# Рекомендации по доработке `docs/design-guidelines/visual/visual_character.md`

- Дорабатываемый документ: [docs/design-guidelines/visual/visual_character.md#L1-L79](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/visual_character.md#L1-L79)
...
Фрагмент документа для изменения: [docs/design-guidelines/visual/visual_character.md#L1-L79](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/visual_character.md#L1-L79) (ориентир: `Визуальный характер и база`).
...
Фрагмент документа для изменения: [docs/design-guidelines/visual/visual_character.md#L28-L39](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/visual_character.md#L28-L39) (ориентир: `3) Типографика`).
...
Фрагмент документа для изменения: [docs/design-guidelines/visual/visual_character.md#L1-L79](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/visual_character.md#L1-L79) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/design-guidelines/visual/visual_character.md#L40-L58](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/visual_character.md#L40-L58) (ориентир: `4) Цвет, контраст, состояния`).
