# Рекомендации по доработке `docs/design-guidelines/visual/states_accessibility_content.md`

- Дорабатываемый документ: [docs/design-guidelines/visual/states_accessibility_content.md#L1-L72](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/states_accessibility_content.md#L1-L72)
...
Фрагмент документа для изменения: [docs/design-guidelines/visual/states_accessibility_content.md#L1-L72](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/states_accessibility_content.md#L1-L72) (ориентир: `Состояния, доступность, контент`).
...
Фрагмент документа для изменения: [docs/design-guidelines/visual/states_accessibility_content.md#L1-L72](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/states_accessibility_content.md#L1-L72) (ориентир: `Документ целиком`).
