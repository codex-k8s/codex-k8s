# Рекомендации по доработке `docs/design-guidelines/visual/response_format.md`

- Дорабатываемый документ: [docs/design-guidelines/visual/response_format.md#L1-L29](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/response_format.md#L1-L29)
...
Фрагмент документа для изменения: [docs/design-guidelines/visual/response_format.md#L1-L29](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/response_format.md#L1-L29) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/design-guidelines/visual/response_format.md#L16-L19](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/visual/response_format.md#L16-L19) (ориентир: `Компоненты`).
