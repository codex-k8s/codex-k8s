# Рекомендации по доработке `docs/design-guidelines/common/check_list.md`

- Дорабатываемый документ: [docs/design-guidelines/common/check_list.md#L1-L30](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/check_list.md#L1-L30)
- Профиль рекомендаций: `guideline_checklist_common`
- Дата генерации: `2026-02-06`

## Рекомендации

### 1. Сгруппировать пункты чек-листа по этапам жизненного цикла требований
Что доработать: Перестроить чек-лист так, чтобы пункты были разделены по этапам: выявление, анализ, спецификация, проверка, управление изменениями для архитектуры и межсервисных границ.
...
Фрагмент документа для изменения: [docs/design-guidelines/common/check_list.md#L5-L17](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/check_list.md#L5-L17) (ориентир: `Общее`).
...
Фрагмент документа для изменения: [docs/design-guidelines/common/check_list.md#L1-L30](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/check_list.md#L1-L30) (ориентир: `Общий чек-лист перед PR`).
...
Фрагмент документа для изменения: [docs/design-guidelines/common/check_list.md#L27-L30](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/check_list.md#L27-L30) (ориентир: `Профильные чек-листы`).
