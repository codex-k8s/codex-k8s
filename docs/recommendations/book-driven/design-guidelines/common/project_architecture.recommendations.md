# Рекомендации по доработке `docs/design-guidelines/common/project_architecture.md`

- Дорабатываемый документ: [docs/design-guidelines/common/project_architecture.md#L1-L73](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/project_architecture.md#L1-L73)
...
Фрагмент документа для изменения: [docs/design-guidelines/common/project_architecture.md#L1-L73](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/project_architecture.md#L1-L73) (ориентир: `Архитектура проекта`).
...
Фрагмент документа для изменения: [docs/design-guidelines/common/project_architecture.md#L7-L15](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/project_architecture.md#L7-L15) (ориентир: `Архитектурные ограничения codex-k8s`).
...
Фрагмент документа для изменения: [docs/design-guidelines/common/project_architecture.md#L1-L73](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/project_architecture.md#L1-L73) (ориентир: `Документ целиком`).
