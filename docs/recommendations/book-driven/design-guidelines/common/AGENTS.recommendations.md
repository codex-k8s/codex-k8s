# Рекомендации по доработке `docs/design-guidelines/common/AGENTS.md`

- Дорабатываемый документ: [docs/design-guidelines/common/AGENTS.md#L1-L15](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/AGENTS.md#L1-L15)
...
Фрагмент документа для изменения: [docs/design-guidelines/common/AGENTS.md#L1-L15](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/AGENTS.md#L1-L15) (ориентир: `Документ целиком`).
