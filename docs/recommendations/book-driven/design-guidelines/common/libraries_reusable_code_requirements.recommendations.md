# Рекомендации по доработке `docs/design-guidelines/common/libraries_reusable_code_requirements.md`

- Дорабатываемый документ: [docs/design-guidelines/common/libraries_reusable_code_requirements.md#L1-L50](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/libraries_reusable_code_requirements.md#L1-L50)
...
Фрагмент документа для изменения: [docs/design-guidelines/common/libraries_reusable_code_requirements.md#L1-L50](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/libraries_reusable_code_requirements.md#L1-L50) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/design-guidelines/common/libraries_reusable_code_requirements.md#L1-L50](https://github.com/codex-k8s/codex-k8s/blob/main/docs/design-guidelines/common/libraries_reusable_code_requirements.md#L1-L50) (ориентир: `Библиотеки: требования к выносу переиспользуемого кода`).
