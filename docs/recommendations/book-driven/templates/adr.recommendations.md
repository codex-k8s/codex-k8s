# Рекомендации по доработке `docs/templates/adr.md`

- Дорабатываемый документ: [docs/templates/adr.md#L1-L86](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/adr.md#L1-L86)
...
Фрагмент документа для изменения: [docs/templates/adr.md#L26-L31](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/adr.md#L26-L31) (ориентир: `Контекст`).
...
Фрагмент документа для изменения: [docs/templates/adr.md#L36-L49](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/adr.md#L36-L49) (ориентир: `Рассмотренные варианты`).
...
Фрагмент документа для изменения: [docs/templates/adr.md#L1-L86](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/adr.md#L1-L86) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/adr.md#L67-L72](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/adr.md#L67-L72) (ориентир: `План внедрения (минимально)`).
...
Фрагмент документа для изменения: [docs/templates/adr.md#L32-L35](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/adr.md#L32-L35) (ориентир: `Decision Drivers (что важно)`).
