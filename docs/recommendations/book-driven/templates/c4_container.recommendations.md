# Рекомендации по доработке `docs/templates/c4_container.md`

- Дорабатываемый документ: [docs/templates/c4_container.md#L1-L78](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/c4_container.md#L1-L78)
...
Фрагмент документа для изменения: [docs/templates/c4_container.md#L1-L78](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/c4_container.md#L1-L78) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/c4_container.md#L54-L59](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/c4_container.md#L54-L59) (ориентир: `API`).
...
Фрагмент документа для изменения: [docs/templates/c4_container.md#L74-L78](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/c4_container.md#L74-L78) (ориентир: `Апрув`).
