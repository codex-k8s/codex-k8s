# Рекомендации по доработке `docs/templates/test_plan.md`

- Дорабатываемый документ: [docs/templates/test_plan.md#L1-L87](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_plan.md#L1-L87)
...
Фрагмент документа для изменения: [docs/templates/test_plan.md#L17-L87](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_plan.md#L17-L87) (ориентир: `Test Plan: <Система/Релиз>`).
...
Фрагмент документа для изменения: [docs/templates/test_plan.md#L30-L33](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_plan.md#L30-L33) (ориентир: `3. Введение`).
...
Фрагмент документа для изменения: [docs/templates/test_plan.md#L38-L40](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_plan.md#L38-L40) (ориентир: `5. Риски (software risk issues)`).
...
Фрагмент документа для изменения: [docs/templates/test_plan.md#L60-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_plan.md#L60-L64) (ориентир: `11. Test deliverables`).
...
Фрагмент документа для изменения: [docs/templates/test_plan.md#L34-L37](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_plan.md#L34-L37) (ориентир: `4. Test items (что тестируем)`).
...
Фрагмент документа для изменения: [docs/templates/test_plan.md#L53-L55](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_plan.md#L53-L55) (ориентир: `9. Критерии pass/fail`).
