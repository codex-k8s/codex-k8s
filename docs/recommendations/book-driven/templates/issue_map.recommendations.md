# Рекомендации по доработке `docs/templates/issue_map.md`

- Дорабатываемый документ: [docs/templates/issue_map.md#L1-L23](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/issue_map.md#L1-L23)
...
Фрагмент документа для изменения: [docs/templates/issue_map.md#L1-L23](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/issue_map.md#L1-L23) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/issue_map.md#L11-L23](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/issue_map.md#L11-L23) (ориентир: `Issue ↔ Docs Map`).
