# Рекомендации по доработке `docs/templates/design_doc.md`

- Дорабатываемый документ: [docs/templates/design_doc.md#L1-L114](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/design_doc.md#L1-L114)
...
Фрагмент документа для изменения: [docs/templates/design_doc.md#L27-L33](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/design_doc.md#L27-L33) (ориентир: `Цели / Не-цели`).
...
Фрагмент документа для изменения: [docs/templates/design_doc.md#L102-L105](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/design_doc.md#L102-L105) (ориентир: `Альтернативы и почему отвергли`).
...
Фрагмент документа для изменения: [docs/templates/design_doc.md#L73-L80](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/design_doc.md#L73-L80) (ориентир: `Наблюдаемость (Observability)`).
...
Фрагмент документа для изменения: [docs/templates/design_doc.md#L43-L47](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/design_doc.md#L43-L47) (ориентир: `API/Контракты`).
...
Фрагмент документа для изменения: [docs/templates/design_doc.md#L89-L95](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/design_doc.md#L89-L95) (ориентир: `План выката (Rollout)`).
...
Фрагмент документа для изменения: [docs/templates/design_doc.md#L96-L101](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/design_doc.md#L96-L101) (ориентир: `План отката (Rollback)`).
