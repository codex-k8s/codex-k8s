# Рекомендации по доработке `docs/templates/personas.md`

- Дорабатываемый документ: [docs/templates/personas.md#L1-L41](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/personas.md#L1-L41)
...
Фрагмент документа для изменения: [docs/templates/personas.md#L1-L41](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/personas.md#L1-L41) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/personas.md#L16-L41](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/personas.md#L16-L41) (ориентир: `Personas: <Название>`).
...
Фрагмент документа для изменения: [docs/templates/personas.md#L38-L41](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/personas.md#L38-L41) (ориентир: `Апрув`).
