# Рекомендации по доработке `docs/templates/user_story.md`

- Дорабатываемый документ: [docs/templates/user_story.md#L1-L54](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/user_story.md#L1-L54)
...
Фрагмент документа для изменения: [docs/templates/user_story.md#L1-L54](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/user_story.md#L1-L54) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/user_story.md#L29-L35](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/user_story.md#L29-L35) (ориентир: `Acceptance Criteria (Given/When/Then)`).
...
Фрагмент документа для изменения: [docs/templates/user_story.md#L48-L50](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/user_story.md#L48-L50) (ориентир: `Открытые вопросы`).
