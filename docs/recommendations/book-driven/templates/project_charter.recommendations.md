# Рекомендации по доработке `docs/templates/project_charter.md`

- Дорабатываемый документ: [docs/templates/project_charter.md#L1-L82](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/project_charter.md#L1-L82)
...
Фрагмент документа для изменения: [docs/templates/project_charter.md#L44-L50](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/project_charter.md#L44-L50) (ориентир: `Область (Scope)`).
...
Фрагмент документа для изменения: [docs/templates/project_charter.md#L39-L43](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/project_charter.md#L39-L43) (ориентир: `Пользователи / Стейкхолдеры`).
...
Фрагмент документа для изменения: [docs/templates/project_charter.md#L1-L82](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/project_charter.md#L1-L82) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/project_charter.md#L45-L47](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/project_charter.md#L45-L47) (ориентир: `MVP Scope`).
...
Фрагмент документа для изменения: [docs/templates/project_charter.md#L58-L61](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/project_charter.md#L58-L61) (ориентир: `Риски`).
