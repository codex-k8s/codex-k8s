# Рекомендации по доработке `docs/templates/index.md`

- Дорабатываемый документ: [docs/templates/index.md#L1-L40](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/index.md#L1-L40)
...
Фрагмент документа для изменения: [docs/templates/index.md#L11-L40](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/index.md#L11-L40) (ориентир: `Documentation Index`).
...
Фрагмент документа для изменения: [docs/templates/index.md#L29-L36](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/index.md#L29-L36) (ориентир: `Быстрые ссылки`).
...
Фрагмент документа для изменения: [docs/templates/index.md#L1-L40](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/index.md#L1-L40) (ориентир: `Документ целиком`).
