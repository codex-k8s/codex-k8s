# Рекомендации по доработке `docs/templates/rollback_plan.md`

- Дорабатываемый документ: [docs/templates/rollback_plan.md#L1-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/rollback_plan.md#L1-L64)
...
Фрагмент документа для изменения: [docs/templates/rollback_plan.md#L1-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/rollback_plan.md#L1-L64) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/rollback_plan.md#L16-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/rollback_plan.md#L16-L64) (ориентир: `Rollback Plan: <Система> <Версия>`).
