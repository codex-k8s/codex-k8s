# Рекомендации по доработке `docs/templates/prd.md`

- Дорабатываемый документ: [docs/templates/prd.md#L1-L96](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/prd.md#L1-L96)
...
Фрагмент документа для изменения: [docs/templates/prd.md#L27-L31](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/prd.md#L27-L31) (ориентир: `Проблема и цель`).
...
Фрагмент документа для изменения: [docs/templates/prd.md#L32-L36](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/prd.md#L32-L36) (ориентир: `Пользователи / Персоны`).
...
Фрагмент документа для изменения: [docs/templates/prd.md#L41-L45](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/prd.md#L41-L45) (ориентир: `Требования (Functional Requirements)`).
...
Фрагмент документа для изменения: [docs/templates/prd.md#L84-L88](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/prd.md#L84-L88) (ориентир: `План релиза (черновик)`).
...
Фрагмент документа для изменения: [docs/templates/prd.md#L89-L92](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/prd.md#L89-L92) (ориентир: `Приложения`).
...
Фрагмент документа для изменения: [docs/templates/prd.md#L80-L83](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/prd.md#L80-L83) (ориентир: `Риски и вопросы`).
