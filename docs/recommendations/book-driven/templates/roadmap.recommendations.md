# Рекомендации по доработке `docs/templates/roadmap.md`

- Дорабатываемый документ: [docs/templates/roadmap.md#L1-L40](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/roadmap.md#L1-L40)
...
Фрагмент документа для изменения: [docs/templates/roadmap.md#L15-L40](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/roadmap.md#L15-L40) (ориентир: `Roadmap: <Продукт>`).
...
Фрагмент документа для изменения: [docs/templates/roadmap.md#L1-L40](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/roadmap.md#L1-L40) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/roadmap.md#L34-L36](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/roadmap.md#L34-L36) (ориентир: `Риски roadmap`).
