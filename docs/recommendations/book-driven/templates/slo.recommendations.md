# Рекомендации по доработке `docs/templates/slo.md`

- Дорабатываемый документ: [docs/templates/slo.md#L1-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/slo.md#L1-L64)
...
Фрагмент документа для изменения: [docs/templates/slo.md#L17-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/slo.md#L17-L64) (ориентир: `SLO Document: <Сервис>`).
...
Фрагмент документа для изменения: [docs/templates/slo.md#L1-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/slo.md#L1-L64) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/slo.md#L61-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/slo.md#L61-L64) (ориентир: `Апрув`).
...
Фрагмент документа для изменения: [docs/templates/slo.md#L52-L56](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/slo.md#L52-L56) (ориентир: `Alerting (на основе burn rate)`).
