# Рекомендации по доработке `docs/templates/incident_playbook.md`

- Дорабатываемый документ: [docs/templates/incident_playbook.md#L1-L70](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/incident_playbook.md#L1-L70)
...
Фрагмент документа для изменения: [docs/templates/incident_playbook.md#L15-L70](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/incident_playbook.md#L15-L70) (ориентир: `Incident Playbook: <Сервис/Система>`).
...
Фрагмент документа для изменения: [docs/templates/incident_playbook.md#L1-L70](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/incident_playbook.md#L1-L70) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/incident_playbook.md#L63-L66](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/incident_playbook.md#L63-L66) (ориентир: `Postmortem requirement`).
