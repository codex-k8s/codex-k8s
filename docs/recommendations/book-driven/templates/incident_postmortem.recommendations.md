# Рекомендации по доработке `docs/templates/incident_postmortem.md`

- Дорабатываемый документ: [docs/templates/incident_postmortem.md#L1-L76](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/incident_postmortem.md#L1-L76)
...
Фрагмент документа для изменения: [docs/templates/incident_postmortem.md#L1-L76](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/incident_postmortem.md#L1-L76) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/incident_postmortem.md#L23-L76](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/incident_postmortem.md#L23-L76) (ориентир: `Postmortem: <Инцидент>`).
