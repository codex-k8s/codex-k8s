# Рекомендации по доработке `docs/templates/regression_checklist.md`

- Дорабатываемый документ: [docs/templates/regression_checklist.md#L1-L46](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/regression_checklist.md#L1-L46)
...
Фрагмент документа для изменения: [docs/templates/regression_checklist.md#L1-L46](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/regression_checklist.md#L1-L46) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/regression_checklist.md#L43-L46](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/regression_checklist.md#L43-L46) (ориентир: `Апрув`).
