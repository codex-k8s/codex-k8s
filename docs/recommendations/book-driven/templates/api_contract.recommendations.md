# Рекомендации по доработке `docs/templates/api_contract.md`

- Дорабатываемый документ: [docs/templates/api_contract.md#L1-L59](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/api_contract.md#L1-L59)
...
Фрагмент документа для изменения: [docs/templates/api_contract.md#L1-L59](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/api_contract.md#L1-L59) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/api_contract.md#L17-L59](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/api_contract.md#L17-L59) (ориентир: `API Contract Overview: <Сервис>`).
...
Фрагмент документа для изменения: [docs/templates/api_contract.md#L56-L59](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/api_contract.md#L56-L59) (ориентир: `Апрув`).
