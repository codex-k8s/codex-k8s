# Рекомендации по доработке `docs/templates/delivery_plan.md`

- Дорабатываемый документ: [docs/templates/delivery_plan.md#L1-L72](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/delivery_plan.md#L1-L72)
...
Фрагмент документа для изменения: [docs/templates/delivery_plan.md#L44-L48](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/delivery_plan.md#L44-L48) (ориентир: `План сред/окружений`).
...
Фрагмент документа для изменения: [docs/templates/delivery_plan.md#L18-L72](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/delivery_plan.md#L18-L72) (ориентир: `Delivery Plan: <Название>`).
...
Фрагмент документа для изменения: [docs/templates/delivery_plan.md#L1-L72](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/delivery_plan.md#L1-L72) (ориентир: `Документ целиком`).
