# Рекомендации по доработке `docs/templates/migrations_policy.md`

- Дорабатываемый документ: [docs/templates/migrations_policy.md#L1-L55](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/migrations_policy.md#L1-L55)
...
Фрагмент документа для изменения: [docs/templates/migrations_policy.md#L1-L55](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/migrations_policy.md#L1-L55) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/migrations_policy.md#L40-L44](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/migrations_policy.md#L40-L44) (ориентир: `Политика rollback`).
