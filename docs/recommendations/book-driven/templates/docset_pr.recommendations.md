# Рекомендации по доработке `docs/templates/docset_pr.md`

- Дорабатываемый документ: [docs/templates/docset_pr.md#L1-L42](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/docset_pr.md#L1-L42)
...
Фрагмент документа для изменения: [docs/templates/docset_pr.md#L19-L42](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/docset_pr.md#L19-L42) (ориентир: `DocSet: PR #<N> — <Короткое название>`).
...
Фрагмент документа для изменения: [docs/templates/docset_pr.md#L1-L42](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/docset_pr.md#L1-L42) (ориентир: `Документ целиком`).
