# Рекомендации по доработке `docs/templates/test_strategy.md`

- Дорабатываемый документ: [docs/templates/test_strategy.md#L1-L70](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_strategy.md#L1-L70)
...
Фрагмент документа для изменения: [docs/templates/test_strategy.md#L17-L70](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_strategy.md#L17-L70) (ориентир: `Test Strategy: <Система/Фича>`).
...
Фрагмент документа для изменения: [docs/templates/test_strategy.md#L1-L70](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_strategy.md#L1-L70) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/test_strategy.md#L64-L66](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_strategy.md#L64-L66) (ориентир: `Риски и меры`).
...
Фрагмент документа для изменения: [docs/templates/test_strategy.md#L67-L70](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_strategy.md#L67-L70) (ориентир: `Апрув`).
