# Рекомендации по доработке `docs/templates/data_model.md`

- Дорабатываемый документ: [docs/templates/data_model.md#L1-L61](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/data_model.md#L1-L61)
...
Фрагмент документа для изменения: [docs/templates/data_model.md#L1-L61](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/data_model.md#L1-L61) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/data_model.md#L47-L51](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/data_model.md#L47-L51) (ориентир: `Политика хранения данных`).
...
Фрагмент документа для изменения: [docs/templates/data_model.md#L58-L61](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/data_model.md#L58-L61) (ориентир: `Апрув`).
