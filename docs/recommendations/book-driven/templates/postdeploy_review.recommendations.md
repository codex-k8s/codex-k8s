# Рекомендации по доработке `docs/templates/postdeploy_review.md`

- Дорабатываемый документ: [docs/templates/postdeploy_review.md#L1-L67](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/postdeploy_review.md#L1-L67)
...
Фрагмент документа для изменения: [docs/templates/postdeploy_review.md#L28-L31](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/postdeploy_review.md#L28-L31) (ориентир: `Что планировали выкатить`).
...
Фрагмент документа для изменения: [docs/templates/postdeploy_review.md#L1-L67](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/postdeploy_review.md#L1-L67) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/postdeploy_review.md#L21-L67](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/postdeploy_review.md#L21-L67) (ориентир: `PostDeploy Review: <Система> <vX.Y.Z>`).
...
Фрагмент документа для изменения: [docs/templates/postdeploy_review.md#L58-L60](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/postdeploy_review.md#L58-L60) (ориентир: `Решения/изменения процесса`).
