# Рекомендации по доработке `docs/templates/epic.md`

- Дорабатываемый документ: [docs/templates/epic.md#L1-L52](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/epic.md#L1-L52)
...
Фрагмент документа для изменения: [docs/templates/epic.md#L28-L34](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/epic.md#L28-L34) (ориентир: `Scope`).
...
Фрагмент документа для изменения: [docs/templates/epic.md#L1-L52](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/epic.md#L1-L52) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/epic.md#L40-L42](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/epic.md#L40-L42) (ориентир: `Критерии приемки эпика`).
...
Фрагмент документа для изменения: [docs/templates/epic.md#L46-L48](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/epic.md#L46-L48) (ориентир: `План релиза (верхний уровень)`).
...
Фрагмент документа для изменения: [docs/templates/epic.md#L43-L45](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/epic.md#L43-L45) (ориентир: `Риски/зависимости`).
