# Рекомендации по доработке `docs/templates/monitoring.md`

- Дорабатываемый документ: [docs/templates/monitoring.md#L1-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/monitoring.md#L1-L64)
...
Фрагмент документа для изменения: [docs/templates/monitoring.md#L35-L44](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/monitoring.md#L35-L44) (ориентир: `Метрики (каталог)`).
...
Фрагмент документа для изменения: [docs/templates/monitoring.md#L1-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/monitoring.md#L1-L64) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/monitoring.md#L16-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/monitoring.md#L16-L64) (ориентир: `Monitoring & Observability: <Сервис>`).
...
Фрагмент документа для изменения: [docs/templates/monitoring.md#L61-L64](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/monitoring.md#L61-L64) (ориентир: `Апрув`).
