# Рекомендации по доработке `docs/templates/release_plan.md`

- Дорабатываемый документ: [docs/templates/release_plan.md#L1-L69](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/release_plan.md#L1-L69)
...
Фрагмент документа для изменения: [docs/templates/release_plan.md#L25-L28](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/release_plan.md#L25-L28) (ориентир: `Scope релиза`).
...
Фрагмент документа для изменения: [docs/templates/release_plan.md#L17-L69](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/release_plan.md#L17-L69) (ориентир: `Release Plan: <Система> <Версия>`).
...
Фрагмент документа для изменения: [docs/templates/release_plan.md#L37-L41](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/release_plan.md#L37-L41) (ориентир: `План выката (шаги)`).
