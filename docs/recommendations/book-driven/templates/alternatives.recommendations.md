# Рекомендации по доработке `docs/templates/alternatives.md`

- Дорабатываемый документ: [docs/templates/alternatives.md#L1-L63](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/alternatives.md#L1-L63)
...
Фрагмент документа для изменения: [docs/templates/alternatives.md#L24-L27](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/alternatives.md#L24-L27) (ориентир: `Контекст`).
...
Фрагмент документа для изменения: [docs/templates/alternatives.md#L28-L34](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/alternatives.md#L28-L34) (ориентир: `Вариант A: <Название>`).
...
Фрагмент документа для изменения: [docs/templates/alternatives.md#L1-L63](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/alternatives.md#L1-L63) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/alternatives.md#L56-L59](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/alternatives.md#L56-L59) (ориентир: `Нужен апрув от Owner`).
