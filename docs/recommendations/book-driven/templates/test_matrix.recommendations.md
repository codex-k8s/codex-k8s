# Рекомендации по доработке `docs/templates/test_matrix.md`

- Дорабатываемый документ: [docs/templates/test_matrix.md#L1-L32](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_matrix.md#L1-L32)
...
Фрагмент документа для изменения: [docs/templates/test_matrix.md#L15-L32](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_matrix.md#L15-L32) (ориентир: `Test Matrix: <Система/Релиз>`).
...
Фрагмент документа для изменения: [docs/templates/test_matrix.md#L1-L32](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_matrix.md#L1-L32) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/test_matrix.md#L26-L28](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_matrix.md#L26-L28) (ориентир: `Дефекты/риски по зонам`).
...
Фрагмент документа для изменения: [docs/templates/test_matrix.md#L29-L32](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/test_matrix.md#L29-L32) (ориентир: `Апрув`).
