# Рекомендации по доработке `docs/templates/scope_mvp.md`

- Дорабатываемый документ: [docs/templates/scope_mvp.md#L1-L45](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/scope_mvp.md#L1-L45)
...
Фрагмент документа для изменения: [docs/templates/scope_mvp.md#L17-L45](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/scope_mvp.md#L17-L45) (ориентир: `MVP Scope: <Название>`).
...
Фрагмент документа для изменения: [docs/templates/scope_mvp.md#L1-L45](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/scope_mvp.md#L1-L45) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/scope_mvp.md#L30-L34](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/scope_mvp.md#L30-L34) (ориентир: `MVP Acceptance (что значит “достаточно”)`).
...
Фрагмент документа для изменения: [docs/templates/scope_mvp.md#L38-L41](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/scope_mvp.md#L38-L41) (ориентир: `Риски скоупа`).
