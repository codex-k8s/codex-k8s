# Рекомендации по доработке `docs/templates/c4_context.md`

- Дорабатываемый документ: [docs/templates/c4_context.md#L1-L58](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/c4_context.md#L1-L58)
...
Фрагмент документа для изменения: [docs/templates/c4_context.md#L1-L58](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/c4_context.md#L1-L58) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/c4_context.md#L54-L58](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/c4_context.md#L54-L58) (ориентир: `Апрув`).
