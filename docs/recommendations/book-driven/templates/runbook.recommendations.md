# Рекомендации по доработке `docs/templates/runbook.md`

- Дорабатываемый документ: [docs/templates/runbook.md#L1-L63](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/runbook.md#L1-L63)
...
Фрагмент документа для изменения: [docs/templates/runbook.md#L16-L63](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/runbook.md#L16-L63) (ориентир: `Runbook: <Сервис> — <Сценарий/проблема>`).
...
Фрагмент документа для изменения: [docs/templates/runbook.md#L52-L55](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/runbook.md#L52-L55) (ориентир: `Проверка результата`).
...
Фрагмент документа для изменения: [docs/templates/runbook.md#L44-L48](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/runbook.md#L44-L48) (ориентир: `Эскалация`).
...
Фрагмент документа для изменения: [docs/templates/runbook.md#L49-L51](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/runbook.md#L49-L51) (ориентир: `План отката (если применимо)`).
