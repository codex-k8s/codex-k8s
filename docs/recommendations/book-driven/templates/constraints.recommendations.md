# Рекомендации по доработке `docs/templates/constraints.md`

- Дорабатываемый документ: [docs/templates/constraints.md#L1-L49](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/constraints.md#L1-L49)
...
Фрагмент документа для изменения: [docs/templates/constraints.md#L1-L49](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/constraints.md#L1-L49) (ориентир: `Документ целиком`).
...
Фрагмент документа для изменения: [docs/templates/constraints.md#L43-L45](https://github.com/codex-k8s/codex-k8s/blob/main/docs/templates/constraints.md#L43-L45) (ориентир: `Неизменяемые решения (если уже есть)`).
