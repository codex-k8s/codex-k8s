...
Секрет с GitHub token в репозитории не хранится. Он создаётся из env (`CODEXK8S_GITHUB_PAT`) во время bootstrap.
...
export CODEXK8S_GITHUB_PAT=<fine-grained-token>
