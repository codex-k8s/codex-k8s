...
legacy_image_repo="${CODEXK8S_INTERNAL_IMAGE_REPOSITORY:-}"
legacy_image="${CODEXK8S_IMAGE:-}"
if [ -n "${legacy_image_repo}" ]; then
  CODEXK8S_API_GATEWAY_INTERNAL_IMAGE_REPOSITORY="${CODEXK8S_API_GATEWAY_INTERNAL_IMAGE_REPOSITORY:-${legacy_image_repo}}"
  CODEXK8S_CONTROL_PLANE_INTERNAL_IMAGE_REPOSITORY="${CODEXK8S_CONTROL_PLANE_INTERNAL_IMAGE_REPOSITORY:-${legacy_image_repo}}"
  CODEXK8S_WORKER_INTERNAL_IMAGE_REPOSITORY="${CODEXK8S_WORKER_INTERNAL_IMAGE_REPOSITORY:-${legacy_image_repo}}"
else
...
if [ -n "${legacy_image}" ]; then
  CODEXK8S_API_GATEWAY_IMAGE="${CODEXK8S_API_GATEWAY_IMAGE:-${legacy_image}}"
  CODEXK8S_CONTROL_PLANE_IMAGE="${CODEXK8S_CONTROL_PLANE_IMAGE:-${legacy_image}}"
  CODEXK8S_WORKER_IMAGE="${CODEXK8S_WORKER_IMAGE:-${legacy_image}}"
else
