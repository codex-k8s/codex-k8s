...
func defaultTemplateVars() map[string]string {
	return map[string]string{
		...
		"CODEXK8S_POSTGRES_IMAGE":                     "pgvector/pgvector:pg16",
		"CODEXK8S_BUSYBOX_IMAGE":                      "busybox:1.36",
		"CODEXK8S_OAUTH2_PROXY_IMAGE":                 "quay.io/oauth2-proxy/oauth2-proxy:v7.6.0",
		"CODEXK8S_CODEGEN_CHECK_IMAGE":                "golang:1.24-bookworm",
		...
		"CODEXK8S_KANIKO_CLONE_IMAGE":                 "alpine/git:2.47.2",
		"CODEXK8S_KANIKO_EXECUTOR_IMAGE":              "gcr.io/kaniko-project/executor:v1.23.2-debug",
