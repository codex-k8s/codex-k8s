export const ru = {
  ...
  pages: {
    ...
    runtimeDeployTaskDetails: {
      ...
      realtimeConnected: "подключено",
      realtimeReconnecting: "переподключение",
      cancelAction: "Запросить cancel",
      stopAction: "Запросить stop",
      cancelConfirm: "Отправить безопасный cancel для этой задачи deploy.",
      stopConfirm: "Отправить stop для зависшего running deploy. Действие применимо только к задаче с активным lease.",
      ...
      cancelAudit: "Аудит cancel",
      stopAudit: "Аудит stop",
    },
    waitQueue: {
