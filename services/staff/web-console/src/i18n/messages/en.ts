export const en = {
  ...
  pages: {
    ...
    runtimeDeployTaskDetails: {
      ...
      stopAction: "Request stop",
      cancelConfirm: "Send a safe cancel request for this deploy task.",
      stopConfirm: "Send a stop request for a stuck running deploy. This is only valid for a task with an active lease.",
