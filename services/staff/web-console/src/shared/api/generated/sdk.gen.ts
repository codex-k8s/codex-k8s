 ...
 */
export const connectRealtimeWs = <ThrowOnError extends boolean = false>(options?: Options<ConnectRealtimeWsData, ThrowOnError>) => (options?.client ?? client).get<unknown, ConnectRealtimeWsErrors, ThrowOnError>({ url: '/api/v1/staff/realtime/ws', ...options });
