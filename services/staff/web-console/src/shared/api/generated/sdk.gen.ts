 ...
 */
export const transitionIssueStageLabel = <ThrowOnError extends boolean = false>(options: Options<TransitionIssueStageLabelData, ThrowOnError>) => (options.client ?? client).post<TransitionIssueStageLabelResponses, TransitionIssueStageLabelErrors, ThrowOnError>({
    responseType: 'json',
