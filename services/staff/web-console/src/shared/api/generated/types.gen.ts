...
export type DeleteRegistryImageTagErrors = {
    /**
     * Invalid request
     */
    400: ErrorResponse;
...
export type DeleteRegistryImageTagError = DeleteRegistryImageTagErrors[keyof DeleteRegistryImageTagErrors];

export type DeleteRegistryImageTagResponses = {
    /**
     * Registry image tag delete result
     */
    200: RegistryImageDeleteResult;
};

export type DeleteRegistryImageTagResponse = DeleteRegistryImageTagResponses[keyof DeleteRegistryImageTagResponses];

export type ListRegistryImagesData = {
    body?: never;
    path?: never;
    query?: {
        repository?: string;
...
export type ListRegistryImagesErrors = {
    /**
     * Invalid request
     */
    400: ErrorResponse;
...
export type ListRegistryImagesError = ListRegistryImagesErrors[keyof ListRegistryImagesErrors];

export type ListRegistryImagesResponses = {
    /**
     * Registry image repositories list
     */
    200: RegistryImageRepositoryItemsResponse;
};

export type ListRegistryImagesResponse = ListRegistryImagesResponses[keyof ListRegistryImagesResponses];

export type CleanupRegistryImagesData = {
    body: CleanupRegistryImagesRequest;
    path?: never;
    query?: never;
    url: '/api/v1/staff/runtime-deploy/images/cleanup';
};

export type CleanupRegistryImagesErrors = {
    /**
     * Invalid request
     */
    400: ErrorResponse;
...
export type CleanupRegistryImagesError = CleanupRegistryImagesErrors[keyof CleanupRegistryImagesErrors];

export type CleanupRegistryImagesResponses = {
    /**
     * Registry cleanup execution result
     */
    200: CleanupRegistryImagesResponse;
};

export type CleanupRegistryImagesResponse2 = CleanupRegistryImagesResponses[keyof CleanupRegistryImagesResponses];
