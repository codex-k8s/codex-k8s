...
var file_codexk8s_controlplane_v1_controlplane_proto_msgTypes = make([]protoimpl.MessageInfo, 110)
var file_codexk8s_controlplane_v1_controlplane_proto_goTypes = []any{
	...
	(*InsertRunFlowEventRequest)(nil),                   // 100: codexk8s.controlplane.v1.InsertRunFlowEventRequest
	(*InsertRunFlowEventResponse)(nil),                  // 101: codexk8s.controlplane.v1.InsertRunFlowEventResponse
	(*UpsertRunStatusCommentRequest)(nil),               // 102: codexk8s.controlplane.v1.UpsertRunStatusCommentRequest
	(*UpsertRunStatusCommentResponse)(nil),              // 103: codexk8s.controlplane.v1.UpsertRunStatusCommentResponse
	(*GetCodexAuthRequest)(nil),                         // 104: codexk8s.controlplane.v1.GetCodexAuthRequest
	(*GetCodexAuthResponse)(nil),                        // 105: codexk8s.controlplane.v1.GetCodexAuthResponse
	(*UpsertCodexAuthRequest)(nil),                      // 106: codexk8s.controlplane.v1.UpsertCodexAuthRequest
	(*UpsertCodexAuthResponse)(nil),                     // 107: codexk8s.controlplane.v1.UpsertCodexAuthResponse
	(*DeleteRunNamespaceRequest)(nil),                   // 108: codexk8s.controlplane.v1.DeleteRunNamespaceRequest
	(*DeleteRunNamespaceResponse)(nil),                  // 109: codexk8s.controlplane.v1.DeleteRunNamespaceResponse
...
var file_codexk8s_controlplane_v1_controlplane_proto_depIdxs = []int32{
	110, // 0: codexk8s.controlplane.v1.IngestGitHubWebhookRequest.received_at:type_name -> google.protobuf.Timestamp
	...
	110, // 8: codexk8s.controlplane.v1.Run.created_at:type_name -> google.protobuf.Timestamp
	110, // 9: codexk8s.controlplane.v1.Run.started_at:type_name -> google.protobuf.Timestamp
	110, // 10: codexk8s.controlplane.v1.Run.finished_at:type_name -> google.protobuf.Timestamp
	110, // 11: codexk8s.controlplane.v1.Run.wait_since:type_name -> google.protobuf.Timestamp
	110, // 12: codexk8s.controlplane.v1.Run.last_heartbeat_at:type_name -> google.protobuf.Timestamp
	111, // 13: codexk8s.controlplane.v1.ApprovalRequest.issue_number:type_name -> google.protobuf.Int32Value
	111, // 14: codexk8s.controlplane.v1.ApprovalRequest.pr_number:type_name -> google.protobuf.Int32Value
	110, // 15: codexk8s.controlplane.v1.ApprovalRequest.created_at:type_name -> google.protobuf.Timestamp
	...
	110, // 27: codexk8s.controlplane.v1.RunLogs.updated_at:type_name -> google.protobuf.Timestamp
	110, // 28: codexk8s.controlplane.v1.FlowEvent.created_at:type_name -> google.protobuf.Timestamp
	...
	110, // 31: codexk8s.controlplane.v1.LearningFeedback.created_at:type_name -> google.protobuf.Timestamp
	...
	112, // 38: codexk8s.controlplane.v1.ProjectMember.learning_mode_override:type_name -> google.protobuf.BoolValue
	...
	112, // 44: codexk8s.controlplane.v1.SetProjectMemberLearningModeOverrideRequest.enabled:type_name -> google.protobuf.BoolValue
	...
	110, // 52: codexk8s.controlplane.v1.RunRepositoryPreflightResponse.finished_at:type_name -> google.protobuf.Timestamp
	...
	110, // 64: codexk8s.controlplane.v1.IssueRunMCPTokenResponse.expires_at:type_name -> google.protobuf.Timestamp
	110, // 65: codexk8s.controlplane.v1.RuntimeDeployTaskLog.created_at:type_name -> google.protobuf.Timestamp
	110, // 66: codexk8s.controlplane.v1.RuntimeDeployTask.lease_until:type_name -> google.protobuf.Timestamp
	110, // 67: codexk8s.controlplane.v1.RuntimeDeployTask.cancel_requested_at:type_name -> google.protobuf.Timestamp
	110, // 68: codexk8s.controlplane.v1.RuntimeDeployTask.stop_requested_at:type_name -> google.protobuf.Timestamp
	110, // 69: codexk8s.controlplane.v1.RuntimeDeployTask.created_at:type_name -> google.protobuf.Timestamp
	110, // 70: codexk8s.controlplane.v1.RuntimeDeployTask.updated_at:type_name -> google.protobuf.Timestamp
	110, // 71: codexk8s.controlplane.v1.RuntimeDeployTask.started_at:type_name -> google.protobuf.Timestamp
	110, // 72: codexk8s.controlplane.v1.RuntimeDeployTask.finished_at:type_name -> google.protobuf.Timestamp
	...
	110, // 79: codexk8s.controlplane.v1.RuntimeError.viewed_at:type_name -> google.protobuf.Timestamp
	110, // 80: codexk8s.controlplane.v1.RuntimeError.created_at:type_name -> google.protobuf.Timestamp
	...
	110, // 84: codexk8s.controlplane.v1.RegistryImageTag.created_at:type_name -> google.protobuf.Timestamp
	...
	111, // 92: codexk8s.controlplane.v1.UpsertAgentSessionRequest.issue_number:type_name -> google.protobuf.Int32Value
	111, // 93: codexk8s.controlplane.v1.UpsertAgentSessionRequest.pr_number:type_name -> google.protobuf.Int32Value
	110, // 94: codexk8s.controlplane.v1.UpsertAgentSessionRequest.started_at:type_name -> google.protobuf.Timestamp
	110, // 95: codexk8s.controlplane.v1.UpsertAgentSessionRequest.finished_at:type_name -> google.protobuf.Timestamp
	111, // 96: codexk8s.controlplane.v1.AgentSessionSnapshot.issue_number:type_name -> google.protobuf.Int32Value
	111, // 97: codexk8s.controlplane.v1.AgentSessionSnapshot.pr_number:type_name -> google.protobuf.Int32Value
	110, // 98: codexk8s.controlplane.v1.AgentSessionSnapshot.started_at:type_name -> google.protobuf.Timestamp
