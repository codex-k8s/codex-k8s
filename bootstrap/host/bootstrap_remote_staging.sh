...
CODEXK8S_IMAGE="${CODEXK8S_IMAGE:-${CODEXK8S_INTERNAL_REGISTRY_SERVICE}.${CODEXK8S_STAGING_NAMESPACE}.svc.cluster.local:${CODEXK8S_INTERNAL_REGISTRY_PORT}/${CODEXK8S_INTERNAL_IMAGE_REPOSITORY}:latest}"
...
CODEXK8S_INTERNAL_IMAGE_REPOSITORY='$(escape_squote "$CODEXK8S_INTERNAL_IMAGE_REPOSITORY")'
