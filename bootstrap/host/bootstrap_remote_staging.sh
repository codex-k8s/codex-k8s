...
RUN_DEV_REVISE_LABEL="${RUN_DEV_REVISE_LABEL:-run:dev:revise}"
RUN_DEBUG_LABEL="${RUN_DEBUG_LABEL:-run:debug}"
...
MODE_DISCUSSION_LABEL="${MODE_DISCUSSION_LABEL:-mode:discussion}"
...
NEED_EM_LABEL="${NEED_EM_LABEL:-need:em}"
NEED_KM_LABEL="${NEED_KM_LABEL:-need:km}"
NEED_REVIEWER_LABEL="${NEED_REVIEWER_LABEL:-need:reviewer}"
...
RUN_INTAKE_LABEL='$(escape_squote "$RUN_INTAKE_LABEL")'
RUN_INTAKE_REVISE_LABEL='$(escape_squote "$RUN_INTAKE_REVISE_LABEL")'
RUN_VISION_LABEL='$(escape_squote "$RUN_VISION_LABEL")'
RUN_VISION_REVISE_LABEL='$(escape_squote "$RUN_VISION_REVISE_LABEL")'
RUN_PRD_LABEL='$(escape_squote "$RUN_PRD_LABEL")'
RUN_PRD_REVISE_LABEL='$(escape_squote "$RUN_PRD_REVISE_LABEL")'
RUN_ARCH_LABEL='$(escape_squote "$RUN_ARCH_LABEL")'
RUN_ARCH_REVISE_LABEL='$(escape_squote "$RUN_ARCH_REVISE_LABEL")'
RUN_DESIGN_LABEL='$(escape_squote "$RUN_DESIGN_LABEL")'
RUN_DESIGN_REVISE_LABEL='$(escape_squote "$RUN_DESIGN_REVISE_LABEL")'
RUN_PLAN_LABEL='$(escape_squote "$RUN_PLAN_LABEL")'
RUN_PLAN_REVISE_LABEL='$(escape_squote "$RUN_PLAN_REVISE_LABEL")'
RUN_DEV_LABEL='$(escape_squote "$RUN_DEV_LABEL")'
RUN_DEV_REVISE_LABEL='$(escape_squote "$RUN_DEV_REVISE_LABEL")'
RUN_DEBUG_LABEL='$(escape_squote "$RUN_DEBUG_LABEL")'
RUN_DOC_AUDIT_LABEL='$(escape_squote "$RUN_DOC_AUDIT_LABEL")'
RUN_QA_LABEL='$(escape_squote "$RUN_QA_LABEL")'
RUN_RELEASE_LABEL='$(escape_squote "$RUN_RELEASE_LABEL")'
RUN_POSTDEPLOY_LABEL='$(escape_squote "$RUN_POSTDEPLOY_LABEL")'
RUN_OPS_LABEL='$(escape_squote "$RUN_OPS_LABEL")'
RUN_SELF_IMPROVE_LABEL='$(escape_squote "$RUN_SELF_IMPROVE_LABEL")'
RUN_ABORT_LABEL='$(escape_squote "$RUN_ABORT_LABEL")'
RUN_RETHINK_LABEL='$(escape_squote "$RUN_RETHINK_LABEL")'
MODE_DISCUSSION_LABEL='$(escape_squote "$MODE_DISCUSSION_LABEL")'
STATE_BLOCKED_LABEL='$(escape_squote "$STATE_BLOCKED_LABEL")'
STATE_IN_REVIEW_LABEL='$(escape_squote "$STATE_IN_REVIEW_LABEL")'
STATE_APPROVED_LABEL='$(escape_squote "$STATE_APPROVED_LABEL")'
STATE_SUPERSEDED_LABEL='$(escape_squote "$STATE_SUPERSEDED_LABEL")'
STATE_ABANDONED_LABEL='$(escape_squote "$STATE_ABANDONED_LABEL")'
NEED_INPUT_LABEL='$(escape_squote "$NEED_INPUT_LABEL")'
NEED_PM_LABEL='$(escape_squote "$NEED_PM_LABEL")'
NEED_SA_LABEL='$(escape_squote "$NEED_SA_LABEL")'
NEED_QA_LABEL='$(escape_squote "$NEED_QA_LABEL")'
NEED_SRE_LABEL='$(escape_squote "$NEED_SRE_LABEL")'
NEED_EM_LABEL='$(escape_squote "$NEED_EM_LABEL")'
NEED_KM_LABEL='$(escape_squote "$NEED_KM_LABEL")'
NEED_REVIEWER_LABEL='$(escape_squote "$NEED_REVIEWER_LABEL")'
AI_MODEL_GPT_5_3_CODEX_LABEL='$(escape_squote "$AI_MODEL_GPT_5_3_CODEX_LABEL")'
AI_MODEL_GPT_5_3_CODEX_SPARK_LABEL='$(escape_squote "$AI_MODEL_GPT_5_3_CODEX_SPARK_LABEL")'
AI_MODEL_GPT_5_2_CODEX_LABEL='$(escape_squote "$AI_MODEL_GPT_5_2_CODEX_LABEL")'
AI_MODEL_GPT_5_1_CODEX_MAX_LABEL='$(escape_squote "$AI_MODEL_GPT_5_1_CODEX_MAX_LABEL")'
AI_MODEL_GPT_5_2_LABEL='$(escape_squote "$AI_MODEL_GPT_5_2_LABEL")'
AI_MODEL_GPT_5_1_CODEX_MINI_LABEL='$(escape_squote "$AI_MODEL_GPT_5_1_CODEX_MINI_LABEL")'
AI_REASONING_LOW_LABEL='$(escape_squote "$AI_REASONING_LOW_LABEL")'
AI_REASONING_MEDIUM_LABEL='$(escape_squote "$AI_REASONING_MEDIUM_LABEL")'
AI_REASONING_HIGH_LABEL='$(escape_squote "$AI_REASONING_HIGH_LABEL")'
AI_REASONING_EXTRA_HIGH_LABEL='$(escape_squote "$AI_REASONING_EXTRA_HIGH_LABEL")'
