...
prompt_if_empty CODEXK8S_GITHUB_REPO "Platform GitHub repo (owner/name)"
...
prompt_if_empty CODEXK8S_OPENAI_API_KEY "CODEXK8S_OPENAI_API_KEY (optional; leave empty to use Codex device auth)" true
...
prompt_if_empty CODEXK8S_PRODUCTION_DOMAIN "Production domain (required)"
CODEXK8S_AI_DOMAIN="${CODEXK8S_AI_DOMAIN:-ai.${CODEXK8S_PRODUCTION_DOMAIN}}"
prompt_if_empty CODEXK8S_AI_DOMAIN "AI domain (required)"
prompt_if_empty CODEXK8S_LETSENCRYPT_EMAIL "Let's Encrypt contact email (required)"

CODEXK8S_FIRST_PROJECT_GITHUB_REPO="${CODEXK8S_FIRST_PROJECT_GITHUB_REPO:-$CODEXK8S_GITHUB_REPO}"
CODEXK8S_GITHUB_WEBHOOK_URL="${CODEXK8S_GITHUB_WEBHOOK_URL:-https://${CODEXK8S_PRODUCTION_DOMAIN}/api/v1/webhooks/github}"
...
CODEXK8S_PROJECT_DB_LIFECYCLE_ALLOWED_ENVS="${CODEXK8S_PROJECT_DB_LIFECYCLE_ALLOWED_ENVS:-dev,production,prod}"
...
CODEXK8S_AI_MODEL_GPT_5_4_LABEL="${CODEXK8S_AI_MODEL_GPT_5_4_LABEL:-[ai-model-gpt-5.4]}"
...
CODEXK8S_WORKER_REPLICAS="${CODEXK8S_WORKER_REPLICAS:-3}"
CODEXK8S_WORKER_POLL_INTERVAL="${CODEXK8S_WORKER_POLL_INTERVAL:-5s}"
CODEXK8S_WORKER_CLAIM_LIMIT="${CODEXK8S_WORKER_CLAIM_LIMIT:-10}"
...
CODEXK8S_KANIKO_CACHE_ENABLED="${CODEXK8S_KANIKO_CACHE_ENABLED:-false}"
...
CODEXK8S_KANIKO_CACHE_COPY_LAYERS="${CODEXK8S_KANIKO_CACHE_COPY_LAYERS:-true}"
CODEXK8S_KANIKO_SNAPSHOT_MODE="${CODEXK8S_KANIKO_SNAPSHOT_MODE:-redo}"
CODEXK8S_KANIKO_SINGLE_SNAPSHOT="${CODEXK8S_KANIKO_SINGLE_SNAPSHOT:-true}"
CODEXK8S_KANIKO_USE_NEW_RUN="${CODEXK8S_KANIKO_USE_NEW_RUN:-true}"
CODEXK8S_KANIKO_VERBOSITY="${CODEXK8S_KANIKO_VERBOSITY:-info}"
CODEXK8S_KANIKO_CLEANUP="${CODEXK8S_KANIKO_CLEANUP:-true}"
CODEXK8S_KANIKO_CPU_REQUEST="${CODEXK8S_KANIKO_CPU_REQUEST:-4}"
CODEXK8S_KANIKO_MEMORY_REQUEST="${CODEXK8S_KANIKO_MEMORY_REQUEST:-8Gi}"
CODEXK8S_KANIKO_CPU_LIMIT="${CODEXK8S_KANIKO_CPU_LIMIT:-16}"
CODEXK8S_KANIKO_MEMORY_LIMIT="${CODEXK8S_KANIKO_MEMORY_LIMIT:-32Gi}"
CODEXK8S_KANIKO_MAX_PARALLEL="${CODEXK8S_KANIKO_MAX_PARALLEL:-${CODEXK8S_KANIKO_MATRIX_MAX_PARALLEL:-4}}"
CODEXK8S_IMAGE_MIRROR_ENABLED="${CODEXK8S_IMAGE_MIRROR_ENABLED:-true}"
CODEXK8S_IMAGE_MIRROR_TOOL_IMAGE="${CODEXK8S_IMAGE_MIRROR_TOOL_IMAGE:-gcr.io/go-containerregistry/crane:debug}"
CODEXK8S_IMAGE_MIRROR_PLATFORM="${CODEXK8S_IMAGE_MIRROR_PLATFORM:-linux/amd64}"
CODEXK8S_REGISTRY_CLEANUP_KEEP_TAGS="${CODEXK8S_REGISTRY_CLEANUP_KEEP_TAGS:-5}"
CODEXK8S_KANIKO_CLONE_IMAGE="${CODEXK8S_KANIKO_CLONE_IMAGE:-}"
CODEXK8S_KANIKO_EXECUTOR_IMAGE="${CODEXK8S_KANIKO_EXECUTOR_IMAGE:-}"
CODEXK8S_BUSYBOX_IMAGE="${CODEXK8S_BUSYBOX_IMAGE:-}"
CODEXK8S_POSTGRES_IMAGE="${CODEXK8S_POSTGRES_IMAGE:-}"
CODEXK8S_OAUTH2_PROXY_IMAGE="${CODEXK8S_OAUTH2_PROXY_IMAGE:-}"
CODEXK8S_REGISTRY_IMAGE="${CODEXK8S_REGISTRY_IMAGE:-}"
CODEXK8S_CODEGEN_CHECK_IMAGE="${CODEXK8S_CODEGEN_CHECK_IMAGE:-}"
TARGET_PORT="${TARGET_PORT:-22}"
TARGET_ROOT_USER="${TARGET_ROOT_USER:-root}"
...
CODEXK8S_WORKER_K8S_NAMESPACE="${CODEXK8S_WORKER_K8S_NAMESPACE:-$CODEXK8S_PRODUCTION_NAMESPACE}"
...
CODEXK8S_WORKER_JOB_ACTIVE_DEADLINE_SECONDS="${CODEXK8S_WORKER_JOB_ACTIVE_DEADLINE_SECONDS:-18000}"
...
CODEXK8S_CONTROL_PLANE_GRPC_TARGET="${CODEXK8S_CONTROL_PLANE_GRPC_TARGET:-codex-k8s-control-plane.${CODEXK8S_PRODUCTION_NAMESPACE}.svc.cluster.local:9090}"
CODEXK8S_CONTROL_PLANE_MCP_BASE_URL="${CODEXK8S_CONTROL_PLANE_MCP_BASE_URL:-http://codex-k8s-control-plane.${CODEXK8S_PRODUCTION_NAMESPACE}.svc.cluster.local:8081/mcp}"
...
CODEXK8S_RUN_HEAVY_FIELDS_RETENTION_DAYS="${CODEXK8S_RUN_HEAVY_FIELDS_RETENTION_DAYS:-7}"
CODEXK8S_RUN_AGENT_LOGS_RETENTION_DAYS="${CODEXK8S_RUN_AGENT_LOGS_RETENTION_DAYS:-$CODEXK8S_RUN_HEAVY_FIELDS_RETENTION_DAYS}"
...
[ -n "${CODEXK8S_PRODUCTION_DOMAIN:-}" ] || die "CODEXK8S_PRODUCTION_DOMAIN is required"
...
if [ -z "${CODEXK8S_OPENAI_API_KEY:-}" ]; then
  log "NOTE: CODEXK8S_OPENAI_API_KEY is empty. Agent runs will use Codex device auth on first use (see run logs)."
fi
...
wait_for_dns_match "$CODEXK8S_PRODUCTION_DOMAIN" "$TARGET_HOST" "$CODEXK8S_DNS_WAIT_TIMEOUT" "$CODEXK8S_DNS_WAIT_INTERVAL"

if [ -z "$CODEXK8S_PUBLIC_BASE_URL" ]; then
  CODEXK8S_PUBLIC_BASE_URL="https://${CODEXK8S_PRODUCTION_DOMAIN}"
fi
...
CODEXK8S_FIRST_PROJECT_GITHUB_REPO='$(escape_squote "$CODEXK8S_FIRST_PROJECT_GITHUB_REPO")'
CODEXK8S_GITHUB_PAT='$(escape_squote "$CODEXK8S_GITHUB_PAT")'
CODEXK8S_REMOTE_REPO_ARCHIVE='$(escape_squote "$REMOTE_REPO_ARCHIVE")'
...
CODEXK8S_RUN_HEAVY_FIELDS_RETENTION_DAYS='$(escape_squote "$CODEXK8S_RUN_HEAVY_FIELDS_RETENTION_DAYS")'
CODEXK8S_RUN_AGENT_LOGS_RETENTION_DAYS='$(escape_squote "$CODEXK8S_RUN_AGENT_LOGS_RETENTION_DAYS")'
CODEXK8S_PRODUCTION_NAMESPACE='$(escape_squote "$CODEXK8S_PRODUCTION_NAMESPACE")'
CODEXK8S_PRODUCTION_DOMAIN='$(escape_squote "$CODEXK8S_PRODUCTION_DOMAIN")'
CODEXK8S_AI_DOMAIN='$(escape_squote "$CODEXK8S_AI_DOMAIN")'
...
CODEXK8S_PLATFORM_DEPLOYMENT_REPLICAS='$(escape_squote "$CODEXK8S_PLATFORM_DEPLOYMENT_REPLICAS")'
...
CODEXK8S_AI_MODEL_GPT_5_4_LABEL='$(escape_squote "$CODEXK8S_AI_MODEL_GPT_5_4_LABEL")'
...
CODEXK8S_KANIKO_CACHE_COPY_LAYERS='$(escape_squote "$CODEXK8S_KANIKO_CACHE_COPY_LAYERS")'
CODEXK8S_KANIKO_SNAPSHOT_MODE='$(escape_squote "$CODEXK8S_KANIKO_SNAPSHOT_MODE")'
CODEXK8S_KANIKO_SINGLE_SNAPSHOT='$(escape_squote "$CODEXK8S_KANIKO_SINGLE_SNAPSHOT")'
CODEXK8S_KANIKO_USE_NEW_RUN='$(escape_squote "$CODEXK8S_KANIKO_USE_NEW_RUN")'
CODEXK8S_KANIKO_VERBOSITY='$(escape_squote "$CODEXK8S_KANIKO_VERBOSITY")'
CODEXK8S_KANIKO_CLEANUP='$(escape_squote "$CODEXK8S_KANIKO_CLEANUP")'
CODEXK8S_KANIKO_CPU_REQUEST='$(escape_squote "$CODEXK8S_KANIKO_CPU_REQUEST")'
CODEXK8S_KANIKO_MEMORY_REQUEST='$(escape_squote "$CODEXK8S_KANIKO_MEMORY_REQUEST")'
CODEXK8S_KANIKO_CPU_LIMIT='$(escape_squote "$CODEXK8S_KANIKO_CPU_LIMIT")'
CODEXK8S_KANIKO_MEMORY_LIMIT='$(escape_squote "$CODEXK8S_KANIKO_MEMORY_LIMIT")'
CODEXK8S_KANIKO_MAX_PARALLEL='$(escape_squote "$CODEXK8S_KANIKO_MAX_PARALLEL")'
CODEXK8S_IMAGE_MIRROR_ENABLED='$(escape_squote "$CODEXK8S_IMAGE_MIRROR_ENABLED")'
CODEXK8S_IMAGE_MIRROR_TOOL_IMAGE='$(escape_squote "$CODEXK8S_IMAGE_MIRROR_TOOL_IMAGE")'
CODEXK8S_IMAGE_MIRROR_PLATFORM='$(escape_squote "$CODEXK8S_IMAGE_MIRROR_PLATFORM")'
CODEXK8S_REGISTRY_CLEANUP_KEEP_TAGS='$(escape_squote "$CODEXK8S_REGISTRY_CLEANUP_KEEP_TAGS")'
CODEXK8S_KANIKO_CLONE_IMAGE='$(escape_squote "$CODEXK8S_KANIKO_CLONE_IMAGE")'
CODEXK8S_KANIKO_EXECUTOR_IMAGE='$(escape_squote "$CODEXK8S_KANIKO_EXECUTOR_IMAGE")'
CODEXK8S_BUSYBOX_IMAGE='$(escape_squote "$CODEXK8S_BUSYBOX_IMAGE")'
CODEXK8S_POSTGRES_IMAGE='$(escape_squote "$CODEXK8S_POSTGRES_IMAGE")'
CODEXK8S_OAUTH2_PROXY_IMAGE='$(escape_squote "$CODEXK8S_OAUTH2_PROXY_IMAGE")'
CODEXK8S_REGISTRY_IMAGE='$(escape_squote "$CODEXK8S_REGISTRY_IMAGE")'
CODEXK8S_CODEGEN_CHECK_IMAGE='$(escape_squote "$CODEXK8S_CODEGEN_CHECK_IMAGE")'
CODEXK8S_RUN_DEV_LABEL='$(escape_squote "$CODEXK8S_RUN_DEV_LABEL")'
CODEXK8S_RUN_DEV_REVISE_LABEL='$(escape_squote "$CODEXK8S_RUN_DEV_REVISE_LABEL")'
CODEXK8S_RUN_DEBUG_LABEL='$(escape_squote "$CODEXK8S_RUN_DEBUG_LABEL")'
...
CODEXK8S_PROJECT_DB_LIFECYCLE_ALLOWED_ENVS='$(escape_squote "$CODEXK8S_PROJECT_DB_LIFECYCLE_ALLOWED_ENVS")'
