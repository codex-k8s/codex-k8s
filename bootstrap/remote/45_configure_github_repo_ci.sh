...
for legacy_var in STAGING_NAMESPACE STAGING_DOMAIN POSTGRES_DB POSTGRES_USER LEARNING_MODE_DEFAULT RUNNER_NAMESPACE RUNNER_SCALE_SET_NAME RUNNER_MIN RUNNER_MAX RUNNER_IMAGE CODEXK8S_STAGING_RUNNER CODEXK8S_GITHUB_USERNAME CODEXK8S_IMAGE CODEXK8S_INTERNAL_IMAGE_REPOSITORY; do
