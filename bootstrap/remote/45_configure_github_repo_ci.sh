...
set_repo_var CODEXK8S_RUN_INTAKE_LABEL "run:intake"
set_repo_var CODEXK8S_RUN_INTAKE_REVISE_LABEL "run:intake:revise"
set_repo_var CODEXK8S_RUN_VISION_LABEL "run:vision"
set_repo_var CODEXK8S_RUN_VISION_REVISE_LABEL "run:vision:revise"
set_repo_var CODEXK8S_RUN_PRD_LABEL "run:prd"
set_repo_var CODEXK8S_RUN_PRD_REVISE_LABEL "run:prd:revise"
set_repo_var CODEXK8S_RUN_ARCH_LABEL "run:arch"
set_repo_var CODEXK8S_RUN_ARCH_REVISE_LABEL "run:arch:revise"
set_repo_var CODEXK8S_RUN_DESIGN_LABEL "run:design"
set_repo_var CODEXK8S_RUN_DESIGN_REVISE_LABEL "run:design:revise"
set_repo_var CODEXK8S_RUN_PLAN_LABEL "run:plan"
set_repo_var CODEXK8S_RUN_PLAN_REVISE_LABEL "run:plan:revise"
set_repo_var CODEXK8S_RUN_DEV_LABEL "run:dev"
set_repo_var CODEXK8S_RUN_DEV_REVISE_LABEL "run:dev:revise"
set_repo_var CODEXK8S_RUN_DEBUG_LABEL "run:debug"
set_repo_var CODEXK8S_RUN_DOC_AUDIT_LABEL "run:doc-audit"
set_repo_var CODEXK8S_RUN_QA_LABEL "run:qa"
set_repo_var CODEXK8S_RUN_RELEASE_LABEL "run:release"
set_repo_var CODEXK8S_RUN_POSTDEPLOY_LABEL "run:postdeploy"
set_repo_var CODEXK8S_RUN_OPS_LABEL "run:ops"
set_repo_var CODEXK8S_RUN_SELF_IMPROVE_LABEL "run:self-improve"
set_repo_var CODEXK8S_RUN_ABORT_LABEL "run:abort"
set_repo_var CODEXK8S_RUN_RETHINK_LABEL "run:rethink"
set_repo_var CODEXK8S_MODE_DISCUSSION_LABEL "mode:discussion"
set_repo_var CODEXK8S_STATE_BLOCKED_LABEL "state:blocked"
set_repo_var CODEXK8S_STATE_IN_REVIEW_LABEL "state:in-review"
...
set_repo_var CODEXK8S_AI_MODEL_GPT_5_3_CODEX_LABEL "[ai-model-gpt-5.3-codex]"
set_repo_var CODEXK8S_AI_MODEL_GPT_5_3_CODEX_SPARK_LABEL "[ai-model-gpt-5.3-codex-spark]"
set_repo_var CODEXK8S_AI_MODEL_GPT_5_2_CODEX_LABEL "[ai-model-gpt-5.2-codex]"
set_repo_var CODEXK8S_AI_MODEL_GPT_5_1_CODEX_MAX_LABEL "[ai-model-gpt-5.1-codex-max]"
set_repo_var CODEXK8S_AI_MODEL_GPT_5_2_LABEL "[ai-model-gpt-5.2]"
set_repo_var CODEXK8S_AI_MODEL_GPT_5_1_CODEX_MINI_LABEL "[ai-model-gpt-5.1-codex-mini]"
set_repo_var CODEXK8S_AI_REASONING_LOW_LABEL "[ai-reasoning-low]"
set_repo_var CODEXK8S_AI_REASONING_MEDIUM_LABEL "[ai-reasoning-medium]"
set_repo_var CODEXK8S_AI_REASONING_HIGH_LABEL "[ai-reasoning-high]"
set_repo_var CODEXK8S_AI_REASONING_EXTRA_HIGH_LABEL "[ai-reasoning-extra-high]"

# Ensure label catalog exists in repository (color is intentionally omitted;
# GitHub assigns one automatically if not provided).
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_INTAKE_LABEL "run:intake")" "Start intake stage run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_INTAKE_REVISE_LABEL "run:intake:revise")" "Request intake stage revision"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_VISION_LABEL "run:vision")" "Start vision stage run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_VISION_REVISE_LABEL "run:vision:revise")" "Request vision stage revision"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_PRD_LABEL "run:prd")" "Start PRD stage run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_PRD_REVISE_LABEL "run:prd:revise")" "Request PRD stage revision"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_ARCH_LABEL "run:arch")" "Start architecture stage run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_ARCH_REVISE_LABEL "run:arch:revise")" "Request architecture stage revision"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_DESIGN_LABEL "run:design")" "Start design stage run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_DESIGN_REVISE_LABEL "run:design:revise")" "Request design stage revision"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_PLAN_LABEL "run:plan")" "Start planning stage run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_PLAN_REVISE_LABEL "run:plan:revise")" "Request planning stage revision"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_DEV_LABEL "run:dev")" "Start development run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_DEV_REVISE_LABEL "run:dev:revise")" "Request development revision"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_DEBUG_LABEL "run:debug")" "Retain run namespace for debugging (skip auto cleanup)"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_DOC_AUDIT_LABEL "run:doc-audit")" "Start documentation audit run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_QA_LABEL "run:qa")" "Start QA run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_RELEASE_LABEL "run:release")" "Start release run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_POSTDEPLOY_LABEL "run:postdeploy")" "Start post-deploy checks run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_OPS_LABEL "run:ops")" "Start operations run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_SELF_IMPROVE_LABEL "run:self-improve")" "Start self-improve run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_ABORT_LABEL "run:abort")" "Abort current stage run"
ensure_repo_label "$(get_repo_var CODEXK8S_RUN_RETHINK_LABEL "run:rethink")" "Reopen problem framing and scope"
...
ensure_repo_label "$(get_repo_var CODEXK8S_STATE_IN_REVIEW_LABEL "state:in-review")" "Work is in review"
...
ensure_repo_label "$(get_repo_var CODEXK8S_AI_MODEL_GPT_5_3_CODEX_LABEL "[ai-model-gpt-5.3-codex]")" "Run config: model gpt-5.3-codex"
ensure_repo_label "$(get_repo_var CODEXK8S_AI_MODEL_GPT_5_3_CODEX_SPARK_LABEL "[ai-model-gpt-5.3-codex-spark]")" "Run config: model gpt-5.3-codex-spark"
ensure_repo_label "$(get_repo_var CODEXK8S_AI_MODEL_GPT_5_2_CODEX_LABEL "[ai-model-gpt-5.2-codex]")" "Run config: model gpt-5.2-codex"
ensure_repo_label "$(get_repo_var CODEXK8S_AI_MODEL_GPT_5_1_CODEX_MAX_LABEL "[ai-model-gpt-5.1-codex-max]")" "Run config: model gpt-5.1-codex-max"
ensure_repo_label "$(get_repo_var CODEXK8S_AI_MODEL_GPT_5_2_LABEL "[ai-model-gpt-5.2]")" "Run config: model gpt-5.2"
ensure_repo_label "$(get_repo_var CODEXK8S_AI_MODEL_GPT_5_1_CODEX_MINI_LABEL "[ai-model-gpt-5.1-codex-mini]")" "Run config: model gpt-5.1-codex-mini"
ensure_repo_label "$(get_repo_var CODEXK8S_AI_REASONING_LOW_LABEL "[ai-reasoning-low]")" "Run config: reasoning low"
ensure_repo_label "$(get_repo_var CODEXK8S_AI_REASONING_MEDIUM_LABEL "[ai-reasoning-medium]")" "Run config: reasoning medium"
ensure_repo_label "$(get_repo_var CODEXK8S_AI_REASONING_HIGH_LABEL "[ai-reasoning-high]")" "Run config: reasoning high"
ensure_repo_label "$(get_repo_var CODEXK8S_AI_REASONING_EXTRA_HIGH_LABEL "[ai-reasoning-extra-high]")" "Run config: reasoning extra high"
