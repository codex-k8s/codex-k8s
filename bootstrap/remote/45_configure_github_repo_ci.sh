...
set_repo_var RUN_SELF_IMPROVE_LABEL "run:self-improve"
set_repo_var RUN_ABORT_LABEL "run:abort"
set_repo_var RUN_RETHINK_LABEL "run:rethink"
set_repo_var MODE_DISCUSSION_LABEL "mode:discussion"
...
set_repo_var NEED_EM_LABEL "need:em"
set_repo_var NEED_KM_LABEL "need:km"
set_repo_var NEED_REVIEWER_LABEL "need:reviewer"
set_repo_var AI_MODEL_GPT_5_3_CODEX_LABEL "[ai-model-gpt-5.3-codex]"
set_repo_var AI_MODEL_GPT_5_3_CODEX_SPARK_LABEL "[ai-model-gpt-5.3-codex-spark]"
set_repo_var AI_MODEL_GPT_5_2_CODEX_LABEL "[ai-model-gpt-5.2-codex]"
set_repo_var AI_MODEL_GPT_5_1_CODEX_MAX_LABEL "[ai-model-gpt-5.1-codex-max]"
set_repo_var AI_MODEL_GPT_5_2_LABEL "[ai-model-gpt-5.2]"
set_repo_var AI_MODEL_GPT_5_1_CODEX_MINI_LABEL "[ai-model-gpt-5.1-codex-mini]"
set_repo_var AI_REASONING_LOW_LABEL "[ai-reasoning-low]"
set_repo_var AI_REASONING_MEDIUM_LABEL "[ai-reasoning-medium]"
set_repo_var AI_REASONING_HIGH_LABEL "[ai-reasoning-high]"
set_repo_var AI_REASONING_EXTRA_HIGH_LABEL "[ai-reasoning-extra-high]"
...
ensure_repo_label "$(get_repo_var RUN_SELF_IMPROVE_LABEL "run:self-improve")" "Start self-improve run"
...
ensure_repo_label "$(get_repo_var MODE_DISCUSSION_LABEL "mode:discussion")" "Discussion mode: brainstorm without commit/push/PR"
...
ensure_repo_label "$(get_repo_var NEED_EM_LABEL "need:em")" "Need engineering manager review"
ensure_repo_label "$(get_repo_var NEED_KM_LABEL "need:km")" "Need documentation and traceability review"
ensure_repo_label "$(get_repo_var NEED_REVIEWER_LABEL "need:reviewer")" "Need pre-review from technical reviewer"
ensure_repo_label "$(get_repo_var AI_MODEL_GPT_5_3_CODEX_LABEL "[ai-model-gpt-5.3-codex]")" "Run config: model gpt-5.3-codex"
ensure_repo_label "$(get_repo_var AI_MODEL_GPT_5_3_CODEX_SPARK_LABEL "[ai-model-gpt-5.3-codex-spark]")" "Run config: model gpt-5.3-codex-spark"
ensure_repo_label "$(get_repo_var AI_MODEL_GPT_5_2_CODEX_LABEL "[ai-model-gpt-5.2-codex]")" "Run config: model gpt-5.2-codex"
ensure_repo_label "$(get_repo_var AI_MODEL_GPT_5_1_CODEX_MAX_LABEL "[ai-model-gpt-5.1-codex-max]")" "Run config: model gpt-5.1-codex-max"
ensure_repo_label "$(get_repo_var AI_MODEL_GPT_5_2_LABEL "[ai-model-gpt-5.2]")" "Run config: model gpt-5.2"
ensure_repo_label "$(get_repo_var AI_MODEL_GPT_5_1_CODEX_MINI_LABEL "[ai-model-gpt-5.1-codex-mini]")" "Run config: model gpt-5.1-codex-mini"
ensure_repo_label "$(get_repo_var AI_REASONING_LOW_LABEL "[ai-reasoning-low]")" "Run config: reasoning low"
ensure_repo_label "$(get_repo_var AI_REASONING_MEDIUM_LABEL "[ai-reasoning-medium]")" "Run config: reasoning medium"
ensure_repo_label "$(get_repo_var AI_REASONING_HIGH_LABEL "[ai-reasoning-high]")" "Run config: reasoning high"
ensure_repo_label "$(get_repo_var AI_REASONING_EXTRA_HIGH_LABEL "[ai-reasoning-extra-high]")" "Run config: reasoning extra high"
