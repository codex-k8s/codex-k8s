...
CODEXK8S_INTERNAL_IMAGE_REPOSITORY="${CODEXK8S_INTERNAL_IMAGE_REPOSITORY:-${CODEXK8S_API_GATEWAY_INTERNAL_IMAGE_REPOSITORY}}"
...
CODEXK8S_IMAGE="${CODEXK8S_IMAGE:-${CODEXK8S_API_GATEWAY_IMAGE}}"
