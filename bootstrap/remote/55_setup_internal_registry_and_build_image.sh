...
export CODEXK8S_STAGING_NAMESPACE \
  ...
  CODEXK8S_API_GATEWAY_INTERNAL_IMAGE_REPOSITORY \
  CODEXK8S_CONTROL_PLANE_INTERNAL_IMAGE_REPOSITORY \
  CODEXK8S_WORKER_INTERNAL_IMAGE_REPOSITORY \
  CODEXK8S_AGENT_RUNNER_INTERNAL_IMAGE_REPOSITORY \
  CODEXK8S_WEB_CONSOLE_INTERNAL_IMAGE_REPOSITORY \
...
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_API_GATEWAY_INTERNAL_IMAGE_REPOSITORY" "${CODEXK8S_API_GATEWAY_INTERNAL_IMAGE_REPOSITORY}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_CONTROL_PLANE_INTERNAL_IMAGE_REPOSITORY" "${CODEXK8S_CONTROL_PLANE_INTERNAL_IMAGE_REPOSITORY}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_WORKER_INTERNAL_IMAGE_REPOSITORY" "${CODEXK8S_WORKER_INTERNAL_IMAGE_REPOSITORY}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_AGENT_RUNNER_INTERNAL_IMAGE_REPOSITORY" "${CODEXK8S_AGENT_RUNNER_INTERNAL_IMAGE_REPOSITORY}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_WEB_CONSOLE_INTERNAL_IMAGE_REPOSITORY" "${CODEXK8S_WEB_CONSOLE_INTERNAL_IMAGE_REPOSITORY}"
...
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_KANIKO_CACHE_ENABLED" "${CODEXK8S_KANIKO_CACHE_ENABLED}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_KANIKO_CACHE_REPO" "${CODEXK8S_KANIKO_CACHE_REPO}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_KANIKO_CACHE_TTL" "${CODEXK8S_KANIKO_CACHE_TTL}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_KANIKO_CACHE_COMPRESSED" "${CODEXK8S_KANIKO_CACHE_COMPRESSED}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_KANIKO_RESOURCES_REQUEST_CPU" "${CODEXK8S_KANIKO_RESOURCES_REQUEST_CPU}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_KANIKO_RESOURCES_REQUEST_MEMORY" "${CODEXK8S_KANIKO_RESOURCES_REQUEST_MEMORY}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_KANIKO_RESOURCES_LIMIT_CPU" "${CODEXK8S_KANIKO_RESOURCES_LIMIT_CPU}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_KANIKO_RESOURCES_LIMIT_MEMORY" "${CODEXK8S_KANIKO_RESOURCES_LIMIT_MEMORY}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_API_GATEWAY_IMAGE" "${CODEXK8S_API_GATEWAY_IMAGE}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_CONTROL_PLANE_IMAGE" "${CODEXK8S_CONTROL_PLANE_IMAGE}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_WORKER_IMAGE" "${CODEXK8S_WORKER_IMAGE}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_AGENT_RUNNER_IMAGE" "${CODEXK8S_AGENT_RUNNER_IMAGE}"
set_env_var "${BOOTSTRAP_ENV_FILE}" "CODEXK8S_WEB_CONSOLE_IMAGE" "${CODEXK8S_WEB_CONSOLE_IMAGE}"

log "Internal images for deploy:"
log "  api-gateway: ${CODEXK8S_API_GATEWAY_IMAGE}"
log "  control-plane: ${CODEXK8S_CONTROL_PLANE_IMAGE}"
log "  worker: ${CODEXK8S_WORKER_IMAGE}"
log "  agent-runner: ${CODEXK8S_AGENT_RUNNER_IMAGE}"
log "  web-console: ${CODEXK8S_WEB_CONSOLE_IMAGE}"
